...
require(['vs/editor/editor.main'], function() {
    ...
    const vertModel = monaco.editor.createModel(localStorage.getItem('vs') || 'precision mediump float;\n\nvoid main()\n{\n    gl_Position = vec4(0.0);\n}\n', 'cpp');
    const fragModel = monaco.editor.createModel(localStorage.getItem('fs') || 'precision mediump float;\n\nvoid main()\n{\n    gl_FragColor = vec4(1.0);\n}\n', 'cpp');
